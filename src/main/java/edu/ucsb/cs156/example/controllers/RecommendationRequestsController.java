...
public class RecommendationRequestsController extends ApiController{
    ...
    public Iterable<RecommendationRequest> allRecommendationRequests() {
        Iterable<RecommendationRequest> recreqs = recommendationRequestRepository.findAll();
        return recreqs;
    }
     ...
     * @param professorEmail the email of the professor/recommender
     * @param explanation purpose of the request
     * @param dateRequested when this was requested
     * @param dateNeeded when this needed by
     * @param done whether this request is done or not
